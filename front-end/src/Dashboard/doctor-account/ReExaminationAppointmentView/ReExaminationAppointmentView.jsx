...
const ReExaminationAppointmentView = ({ appointment, prescription }) => {
                ...
                {appointment.status === 'done' && appointment.nextAppointmentTimeSlot && (
                    <>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{convertTime(appointment.nextAppointmentTimeSlot?.startingTime)}</td>
                        ...
                        <div className={cx('confirmation')}>
                            <div>
                                <h4>
                                    HealthMate{prescription?.updatedAt && ', ' + formatDate(prescription?.updatedAt)}
                                </h4>
                                <span>
